        ...
        <div className='grid grid-cols-2 gap-10 mt-5'>
            <div className="flex justify-around items-center">
                <div className="w-[80%] flex flex-col gap-2">
                    <div className="flex justify-center items-center gap-5 bg-violet-200 text-violet-600 text-center rounded-4xl p-1">
                        <div className='relative flex justify-center items-center '>
                            <div class="absolute h-6 w-6 bg-linear-to-r from-[#4F39F6] to-[#9514FA] rounded-full opacity-50"></div>
                            <div class="absolute h-4 w-4 bg-linear-to-r from-[#4F39F6] to-[#9514FA] rounded-full opacity-90"></div>
                            <div class="absolute h-2 w-2 bg-linear-to-r from-[#4F39F6] to-[#9514FA] rounded-full"></div>
                        </div>
                        <p>New: AI-Powered Tools Available</p>
                </div>

                <h1 className='text-3xl font-semibold'>Supercharge Your Digital Workflow</h1>
